...
for j in range(0,20):
    ...
    b = int(input("Enter your move, 1 to cooperate, 0 to defect: "))
    bMoves.append(b)

    if a == 0:
        print("Opponent defected")
    else:
        print("Opponent cooperated")
    ...
    print("Your score:", scoreB)
    print("Opponent score:", scoreA)
    print("\n")
